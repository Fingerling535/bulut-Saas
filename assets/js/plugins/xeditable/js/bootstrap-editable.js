...
(function ($) {
    ...
    var dates = $.fn.datepicker.dates = {
        en: {
            days: ["Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi", "Sunday"],
            daysShort: ["Paz", "Pts", "Sal", "Çar", "Per", "Cum", "Cmt", "Sun"],
            daysMin: ["Pa", "Pt", "Sa", "Ça", "Pe", "Cu", "Ct", "Su"],
            months:"Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran", "Temmuz", "Ağustos", "Eylül", "Ekim", "Kasım", "Aralık",
            monthsShort: ["Oca", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "ğu", "Eyl", "Eki", "Kas", "Ara"],
            today: "Today",
            clear: "Clear"
        }
    };
